				...
				<?php foreach($gameFolders as $gameFolder): ?>
					...
					<div class = "section_card">
						<div class="card">
							...
							<p><?php echo htmlspecialchars($gameInfo);?></p>
							<div class="button-wrapper"><a href="<?php echo 'pages/createGame.php?gameName='. $gameName; ?>" class="create-btn btn outline">Создать игру</a></div>
						</div>
					</div>
				<?php endforeach; ?>
			</section>
